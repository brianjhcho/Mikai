> Archived 2026-04-16 during docs refactor Pass 2. Raw research integration (five papers → L4 design). Active L4 build spec now lives in docs/FOUNDATIONS.md §3.
